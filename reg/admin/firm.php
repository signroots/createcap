        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Firm Table</h4>
                            ...
                            <table id="key-datatable" class="table dt-responsive table-striped nowrap w-100">
                                ...
                                <tbody>
                                    <?php foreach ($firm_db as $k => $v) : ?>
                                        <tr>
                                            <td> <?= $k + 1 ?></td>
                                            <td><?= $v['team_name1'] ?></td>
                                            <td> <?= $v['team_email1']  ?> </td>
                                            <td> <?= $v['team_ph1']  ?> </td>
                                            <td> <a target="_blank" href="for-print/firm.php?id=<?= $v['id'] ?>"> <i class="fas fa-eye"></i> </a>
